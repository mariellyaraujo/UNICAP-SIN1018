...
const WORDS = [
  "REACT", "NEXTJS", "JAVASCRIPT", "COMPONENTE", "ESTADO", "PROPRIEDADES",
  "FORCA", "PROGRAMACAO", "DESENVOLVEDOR", "FRONTEND", "BACKEND", "ALGORITMO",
  "HTML", "CSS", "FLUXO", "REQUISICAO", "API", "INTERFACE", "LOGICA", "REDUX",
  "VITE", "NODE", "EXPRESS", "VERCEL", "BUILD", "DEPLOY", "SERVIDOR", "CLIENTE",
  "TECLADO", "ALEATORIO", "INFORMATICA", "BOTAO"
];
    ...
    <div className="hangman-container">
        ...
        <div className="game-content-wrapper">
            ...
            <div className="game-column main-game-column">
                ...
                {/* Botão de Reinício (Visível após o fim do jogo) */}
                {gameStatus !== 'playing' && (
                    <button onClick={resetGame} className="restart-button desktop-only">
                        Reiniciar Jogo
                    </button>
                )}
            </div>
